# DOC-00-3: Cài đặt Google Drive & Database MCP Server
...
*Trước đó: [DOC-00-2 — Cấu hình mcp_config.json](./DOC-00-2-mcp-client-server-va-cau-hinh.md)*  
*Tiếp theo: [DOC-00-4 — Xây dựng Custom MCP Server](./DOC-00-4-mcp-xay-dung-custom-server.md)*

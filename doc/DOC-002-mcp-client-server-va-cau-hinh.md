# DOC-002: Cấu hình MCP Client-Server — mcp_config.json
...
*Trước đó: [DOC-001 — MCP Tổng quan & Kiến trúc](./DOC-001-mcp-tong-quan-va-kien-truc.md)*  
*Tiếp theo: [DOC-003 — Cài đặt Google Drive & Database MCP Server](./DOC-003-mcp-gdrive-database-setup.md)*

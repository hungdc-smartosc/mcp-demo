# DOC-004: Xây dựng Custom MCP Server từ đầu
...
*Trước đó: [DOC-003 — Cài đặt GDrive & Database MCP](./DOC-003-mcp-gdrive-database-setup.md)*  
*Tiếp theo: [DOC-005 — Tích hợp MCP vào Workflow tự động](./DOC-005-mcp-tich-hop-workflow-tu-dong.md)*
